...
1. **PDF Document Processing**
   ...
   <img src="screenshot_identify_file_type(pdf).png" alt="isolated" width="200"/>
...
2. **Excel Document Processing**
   ...
   <img src="screenshot_identify_file_type(excel).png" alt="isolated" width="200"/>
...
3. **Word Document Processing**
   ...
   <img src="screenshot_identify_file_type(docx).png" alt="isolated" width="200"/>
...
The service includes a functional HTML interface for testing extractions:
   ...
   <img src="functional_test_html.png" alt="isolated" width="200"/>
...
All extraction results are automatically saved for future reference:
   ...
   <img src="generated_output_storage.png" alt="isolated" width="200"/>
